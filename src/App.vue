<template>
        ...
        <div class="container mx-auto px-4 flex justify-between items-center">
          ...
          <div class="hidden md:flex space-x-8 items-center">
            <template v-for="(item, index) in navItems" :key="index">
              ...
              >
                ...
                <span class="absolute -bottom-1 left-0 w-0 h-0.5 
                      bg-cyan-400 transition-all group-hover:w-full"></span>
              </a>
              <router-link 
                v-else
                :to="item.path"
            ...
            <button 
              ...
              class="bg-gradient-to-r from-purple-500 to-cyan-500 
              px-6 py-2 rounded-full text-white shadow-lg hover:shadow-xl 
              transition-shadow hover:scale-[1.02]"
            >
              开始使用
            </button>
          </div>
  ...
  const navItems = ref([
    ...
    { 
      name: '控制台', 
      path: 'https://console.yourdomain.com', 
      isExternal: true,
      target: '_self'
    },
    { 
      name: '文档', 
      path: 'https://docs.yourdomain.com', 
      isExternal: true,
      target: '_blank'
    },
    { 
