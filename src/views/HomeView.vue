<template>
  <main class="pt-32 pb-20">
    ...
    <section class="container mx-auto px-4 text-center mb-28">
      <h1 class="text-5xl md:text-7xl font-bold mb-8 bg-gradient-to-r from-purple-400 to-cyan-400 bg-clip-text text-transparent">
      ...
      <div class="flex flex-col items-center space-y-4">
        ...
        <!-- 调整后的提示文字 -->
        <p class="text-slate-400 text-xs md:text-sm text-center max-w-[280px] leading-relaxed">
          联机平台需要使用 HiMCBBS 账户登录<br>使用前请先注册
        </p>
      </div>
